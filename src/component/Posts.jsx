                    ...
                    {data.map((curElm) => {
                        ...
                        return (
                            ...
                            <li key={id} className="bg-blue-950 rounded-lg p-4 shadow-black shadow-lg border-2 border-white">
                                <p className="text-white text-sm sm:text-base md:text-lg font-semibold">Title: {title}</p>
                                <p className="text-white text-xs sm:text-sm md:text-base">Body: {body}</p>
                                <div className="flex flex-col sm:flex-row justify-center gap-3 mt-3">
                                    <button className="bg-blue-500 border-2 border-gray-300 text-white px-4 py-2 hover:bg-green-400 rounded-xl w-full sm:w-auto">
                                        Edit
                                    </button>
                                    <button
                                        className="bg-blue-500 border-2 border-gray-300 text-white px-3 py-2 hover:bg-red-400 rounded-xl w-full sm:w-auto"
